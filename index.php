...
<html lang="en">
	...
	<body>
		...
		<p><strong>Technology:</strong> Beth is devoted to Apple and has the latest iPhone 7, iPad Pro, a Macbook Air,
			and a 21.5" iMac. She is comfortable in using them, but does not know the entire scope of what they can do.</p>
		...
		<p><strong>Use Case:</strong> Beth is up early as usual on a Tuesday morning with her coffee in hand and all
			...
			and get it done.</p>
		<p><strong>Interaction Flow:</strong> On Etsy homepage, user clicks on &quot;Sell on Etsy&quot;. The browser then
			goes to
